...
namespace AspNet.Security.OAuth.Forms
{
    static class HexUtils
    {
        ...
        internal static byte[] HexStringToByteArray(this string str)
        {
        ...
        public static string ToHexadecimal(this byte[] data)
        {
            if (data == null)
            {
                return null;
        ...
        public static byte[] ToBytesFromHexadecimal(this string data)
        {
